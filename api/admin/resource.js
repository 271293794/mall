...
router.get('/list', async (req, res) => {
    ...
    var pageData = await app_resource().findPage({ where }, { pageSize, pageNum })
    res.sucess(pageData)
...
router.post('/update/:id', async (req, res) => {
    ...
    let affectedRows = await app_resource().update(req.body, { where: { id: req.body.id } })
    res.sucess(affectedRows)


})
router.get('/listAll', async (req, res) => {
    res.sucess(await app_resource().findList())
...
router.post('/create', async (req, res) => {
    ...
    res.sucess(await app_resource().insert(req.body))


})

router.post('/delete/:id', async (req, res) => {
    res.sucess(await app_resource().delAndDelRelation(req.params))
